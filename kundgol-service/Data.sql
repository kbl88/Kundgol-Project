...
CREATE TABLE `category` (
  ...
  `categorynamek` varchar(255) DEFAULT NULL,
...
insert  into `category`(`categoryid`,`categorycode`,`categoryname`,`categorynamek`,`createdby`,`createddate`,`updatedby`,`updateddate`) values
...
CREATE TABLE `person` (
  ...
  `placecode` varchar(255) DEFAULT NULL,
  `updatedby` bigint(20) DEFAULT NULL,
  `updateddate` date DEFAULT NULL,
  `wardcode` varchar(255) DEFAULT NULL,
  `personnamek` varchar(255) DEFAULT NULL,
...
insert  into `person`(`personid`,`aadhaarno`,`contactno`,`createdby`,`createddate`,`personname`,`placecode`,`updatedby`,`updateddate`,`wardcode`,`personnamek`,`address`) values
...
CREATE TABLE `place` (
  ...
  `updateddate` date DEFAULT NULL,
  `placenamek` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`placeid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `place` */

insert  into `place`(`placeid`,`createdby`,`createddate`,`placecode`,`placename`,`updatedby`,`updateddate`,`placenamek`) values
...
CREATE TABLE `public_service` (
  ...
  `servicetype` char(1) DEFAULT NULL,
  PRIMARY KEY (`serviceid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `public_service` */

insert  into `public_service`(`serviceid`,`createdby`,`createddate`,`filename`,`filetype`,`imagedata`,`message`,`personid`,`personname`,`personnamek`,`placecode`,`updatedby`,`updateddate`,`wardcode`,`messagetitle`,`servicetype`) values
...
CREATE TABLE `ward` (
  `wardid` bigint(20) NOT NULL AUTO_INCREMENT,
  `createdby` int(11) NOT NULL,
  `createddate` date NOT NULL,
  ...
  `wardnamek` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`wardid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `ward` */

insert  into `ward`(`wardid`,`createdby`,`createddate`,`placecode`,`updatedby`,`updateddate`,`wardcode`,`wardname`,`wardnamek`) values
